...
import com.gallery.photosgallery.videogallery.pintestgallery.adapters.MediaAdapter
import com.gallery.photosgallery.videogallery.pintestgallery.asynctasks.GetMediaAsynctask
...
import com.gallery.photosgallery.videogallery.pintestgallery.extensions.deleteDBPath
import com.gallery.photosgallery.videogallery.pintestgallery.extensions.directoryDB
import com.gallery.photosgallery.videogallery.pintestgallery.extensions.favoritesDB
import com.gallery.photosgallery.videogallery.pintestgallery.extensions.getCachedMedia
import com.gallery.photosgallery.videogallery.pintestgallery.extensions.getHumanizedFilename
...
import com.gallery.photosgallery.videogallery.pintestgallery.extensions.openPath
import com.gallery.photosgallery.videogallery.pintestgallery.extensions.restoreRecycleBinPaths
...
import com.gallery.photosgallery.videogallery.pintestgallery.helpers.GridSpacingItemDecoration
import com.gallery.photosgallery.videogallery.pintestgallery.helpers.IS_IN_RECYCLE_BIN
...
import com.gallery.photosgallery.videogallery.pintestgallery.helpers.PATH
...
import com.gallery.photosgallery.videogallery.pintestgallery.helpers.SHOW_FAVORITES
import com.gallery.photosgallery.videogallery.pintestgallery.helpers.SHOW_RECYCLE_BIN
...
import com.gallery.photosgallery.videogallery.pintestgallery.interfaces.MediaOperationsListener
...
import com.gallery.photosgallery.videogallery.pintestgallery.models.ThumbnailSection
...
class MediaActivity : SimpleActivity(), MediaOperationsListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(this@MediaActivity, "1234567", Toast.LENGTH_SHORT).show()
...
//                finish()
    ...
    private fun refreshMenuItems() {
        val isDefaultFolder = !config.defaultFolder.isEmpty() && File(config.defaultFolder).compareTo(
            File(mPath)
        ) == 0
        ...
        binding.mediaMenu.getToolbar().menu.apply {
            ...
            findItem(com.simplemobiletools.gallery.pro.R.id.column_count).isVisible = viewType == VIEW_TYPE_GRID
            findItem(com.simplemobiletools.gallery.pro.R.id.toggle_filename).isVisible = viewType == VIEW_TYPE_GRID
        }
    }

    private fun setupOptionsMenu() {
        binding.mediaMenu.getToolbar().inflateMenu(com.simplemobiletools.gallery.pro.R.menu.menu_media)
...
//                finish()
    ...
    private fun itemClicked(path: String) {
        ...
        if (isSetWallpaperIntent()) {
            toast(com.simplemobiletools.gallery.pro.R.string.setting_wallpaper)
